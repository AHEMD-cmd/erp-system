...
@section('title', 'إضافة فئة أصناف جديدة')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title card_title_center">إضافة فئة أصناف جديدة</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                    <form action="{{ route('admin.item-card-categories.store') }}" method="POST">
                        @csrf
