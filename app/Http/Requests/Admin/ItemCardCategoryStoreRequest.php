...
class ItemCardCategoryStoreRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            'name' => [
                ...
                'unique:item_card_categories,name,NULL,id,company_code,' . Auth::user()->company_code,
            ],
    ...
    /**
     * Get the validated data with additional attributes.
     *
