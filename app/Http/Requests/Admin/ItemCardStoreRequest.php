...
class ItemCardStoreRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            // Independent fields
            'name' => 'required|unique:item_cards,name,NULL,id,company_code,' . auth()->user()->company_code,
            ...
            'item_code' => 'required|unique:item_cards,item_code,NULL,id,company_code,' . auth()->user()->company_code,
            'barcode' => 'nullable|unique:item_cards,barcode,NULL,id,company_code,' . auth()->user()->company_code,
